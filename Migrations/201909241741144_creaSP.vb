...
Namespace Migrations
    Partial Public Class Crea_SP
        ...
        Public Overrides Sub Up()
            CreateStoredProcedure("dbo.empresa_cliente_UpdateByCodigo", Function(p) New With {Key .empresa_id = p.Long, .cliente_codigo_c25 = p.String(maxLength:=25), .cliente_nombre_nom = p.String(maxLength:=25), .pais_id = p.Long, .cliente_direccionfacturacion_txt = p.String(), .cliente_direccionenvio_txt = p.String(), .cliente_Telefono_tel = p.String(maxLength:=200), .cliente_email_ema = p.String(maxLength:=200)},
